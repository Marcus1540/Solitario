...
class Carta(arcade.Sprite):
    ...
    def _init_(self, palo, valor, escala=1):
        ...
        super()._init_(self.nombre_archivo_imagen, escala, hit_box_algorithm="None")

class MiJuego(arcade.Window):
    """ Clase principal de la aplicación. """

    def _init_(self):
        super()._init_(ANCHO_PANTALLA, ALTO_PANTALLA, TITULO_PANTALLA)
